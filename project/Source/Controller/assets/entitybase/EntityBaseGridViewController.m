...
- (id)initWithURL:(MenuPage)page query:(NSDictionary *)query
{
    self = [super init];
    if (self) {
...
- (void)launcherView:(TTLauncherView*)launcher didSelectItem:(TTLauncherItem*)item {
    NSDictionary *thisDictionary = [NSDictionary dictionaryWithObjectsAndKeys:_entityBase, @"entityBase",[item userInfo],@"assetsTypeTop",nil];
    TTURLAction *action =  [[[TTURLAction actionWithURLPath:[NSString stringWithFormat:@"tt://assetsRecordTableViewQuery?page=%i",_page]] applyQuery:thisDictionary]
                            applyAnimated:YES];
    [[TTNavigator navigator] openURLAction:action];
}
